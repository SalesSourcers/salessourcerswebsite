const cases = {
  "cypago": {
    ...
    website: "https://cypago.com/",
    source: "https://www.salessourcers.com/revived-outbound-sales-with-a-focused-strategy-that-delivered-immediate-traction-and-high-value-meetings/",
    ...
    campaign: [
      ...
      ["Build technical fluency", "Train the SDR on the product, security context, common objections and buyer priorities."],
    ...
    quoteRole: "Vice President of Sales, Cypago",
    video: "UoUzCFtNQiI",
    impactTitle: "A previously unsuccessful channel became a consistent route to senior security buyers.",
    impact: "The campaign generated 61 sales meetings, more than $630K in pipeline and $120K in closed revenue. It also removed the immediate need to rebuild another internal SDR team.",
    outcomes: [
      "Immediate traction demonstrated that the market would respond to a more focused approach.",
      "Meeting quality improved by concentrating on the decision-makers most relevant to the platform.",
  ...
  "sales-savvy": {
    ...
    source: "https://www.salessourcers.com/sales-sourcers-helped-an-australian-marketing-agency-build-a-repeatable-sales-engine-and-hit-six-figures-in-new-revenue/",
    ...
    campaign: [
      ...
      ["Create demand", "Use cold calling, personalised email and paid activity to open relevant opportunities."],
  ...
  "outbox": {
    ...
    size: "1-10 employees",
    website: "https://www.getoutbox.ai/",
    source: "https://www.salessourcers.com/enabled-a-smooth-transition-from-agency-to-saas-with-a-predictable-sales-pipeline/",
    logo: "assets/client-outbox-color.png",
    accent: "#205cdc",
    headline: "Scattered email activity became a repeatable sales process that supported the move from agency to SaaS.",
    summary: "SalesSourcers clarified the target market, built relevant messaging and managed the path from first contact to qualified demo as Outbox evolved its commercial model.",
    primaryMetric: "$76K",
    ...
    outcomes: [
      ...
      "Qualified demos created a clearer route from product interest to recurring revenue.",
    ...
    fitTitle: "Relevant for early-stage SaaS teams that need pipeline and market learning at the same time.",
    fit: "The model is particularly useful when a product is evolving, the founder needs evidence about which niches respond and every conversation can improve the go-to-market strategy."
  },
  "iscent": {
    name: "iScent",
    ...
    campaign: [
      ["Map premium accounts", "Build the addressable market across priority hospitality and retail segments."],
      ["Track live signals", "Prioritise property openings, refurbishments and other events that create a reason to engage."],
      ["Personalise outreach", "Connect the message to the specific property, event and commercial opportunity."],
      ["Maintain CRM follow-up", "Keep longer-cycle opportunities moving through structured calling, email and follow-up."]
    ],
    quoteLabel: "WRITTEN CLIENT PERSPECTIVE",
    quote: "We have consistent sales meetings each month and managed to sign some huge global brands.",
    founderImage: "assets/founder-saif.png",
    ...
    lessons: [
      ...
      ["Map the full market", "A defined account universe made prioritisation and coverage measurable."],
      ["Plan for longer cycles", "CRM discipline mattered because premium contracts required sustained follow-up."]
    ],
    fitTitle: "Relevant for specialist B2B services selling into a finite set of high-value accounts.",
    fit: "This approach suits companies with a clear premium market, longer sales cycles and identifiable events that make a prospect more likely to consider a new supplier."
  },
  "revcat": {
    name: "Revcat",
    ...
    size: "1-10 employees",
    website: "https://revcat.io/",
    source: "https://www.salessourcers.com/transformed-referral-driven-sales-into-a-scalable-outbound-growth-engine/",
    ...
    challengeTitle: "Revcat had a strong offer, but revenue still depended too heavily on the founder's network.",
    challenge: "Founder Tom Maples had commercial proof and a clear need for more pipeline, but consistent prospecting was difficult to maintain while also running sales conversations, product priorities and investor-facing growth work.",
    challenges: [
    ...
    quoteRole: "Founder and Chief Revenue Officer, Revcat",
    video: "CgKIHdj9MkA",
    ...
    lessons: [
      ["Start with urgency", "Accounts with a visible commercial trigger were more likely to take a serious revenue conversation."],
  ...
  "easygenerator": {
    ...
    website: "https://www.easygenerator.com/",
    source: "https://www.salessourcers.com/secured-enterprise-level-opportunities-with-a-targeted-outbound-strategy-focused-on-high-value-decision-makers/",
    logo: "assets/client-easygenerator-color.png",
    accent: "#f28a21",
    headline: "A targeted enterprise campaign reached senior L&D buyers inside 10,000-plus employee companies.",
    summary: "SalesSourcers complemented an existing SDR team with a more selective account strategy focused on organisational change, senior decision-makers and enterprise value.",
    primaryMetric: "$120K+",
    ...
    approachTitle: "Prioritise organisational change as the reason to approach an enterprise account.",
    approach: "The programme segmented large companies and focused on signals such as mass hiring, new leadership and major organisational shifts before targeting C-suite and VP-level L&D stakeholders.",
    campaign: [
    ...
    outcomes: [
      ...
      "Change signals created a stronger and more timely reason for enterprise outreach.",
      "The external campaign added focused capacity without replacing the existing internal SDR function."
    ],
    lessons: [
  ...
  "the-recipe": {
    ...
    size: "1-10 employees",
    website: "https://therecipeltd.co.nz/",
    ...
    metrics: [["86", "qualified leads"], ["29", "verified sales meetings"], ["3", "new clients"], ["5 months", "reported period"]],
    challengeTitle: "Good referrals arrived, but long dry periods made growth difficult to plan.",
    challenge: "Without a defined ICP or outbound process, founder Daniel Baird could not control when the next opportunity would appear or confidently make decisions about hiring and investment.",
    challenges: [
      "New business arrived mainly through referrals, creating long gaps between opportunities.",
    ...
    outcomes: [
      ...
      "A defined ICP helped the agency focus on businesses most likely to value its offer.",
      "A visible campaign process gave leadership more confidence in future pipeline."
    ],
    lessons: [
      ["Make the market explicit", "A useful ICP defines who should be pursued and who should be excluded."],
      ["Use observable pressure", "Growth and advertising signals gave prospects a clearer reason to reconsider their marketing."],
      ["Create forecastable activity", "Consistent inputs made pipeline easier to understand than intermittent referrals."]
    ],
    fitTitle: "Relevant for small agencies that have grown through reputation but cannot forecast the next quarter.",
    fit: "The model works best when the agency has a proven offer and delivery capacity, but needs a defined market and an accountable process for creating opportunities consistently."
  },
  "fivex": {
    name: "FiveX",
    ...
    size: "11-50 employees",
    website: "https://fivex.com/",
    source: "https://www.salessourcers.com/launched-a-scalable-outbound-strategy-that-helped-enter-new-markets-and-generate-early-wins/",
    logo: "assets/client-fivex-color.png",
    accent: "#5274e7",
    headline: "A coordinated outbound programme tested a new market and created early commercial traction.",
    ...
    approachTitle: "Run two clear market tests instead of forcing one campaign to answer every question.",
    approach: "One motion targeted German and Polish companies showing expansion signals. The second focused on established Dutch eCommerce teams with a need for stronger Bol.com management.",
    campaign: [
    ...
    lessons: [
      ["Separate hypotheses", "Different regions and offers need distinct campaigns if the results are going to teach you anything."],
      ["Learn before scaling", "Early outbound created evidence about demand before larger investment."],
      ["Own the full execution", "Coordinating data, messaging and channels prevented gaps between strategy and activity."]
    ],
    fitTitle: "Relevant for B2B companies launching a service or entering a new region.",
    fit: "This approach is useful when leadership needs early opportunities, but also needs structured evidence about which markets, pains and messages justify further investment."
  },
  "franchise-rocket": {
    ...
    location: "Sydney, Australia",
    size: "11-50 employees",
    website: "https://franchiserocket.io/",
    source: "https://www.salessourcers.com/built-a-direct-outbound-system-that-replaced-partner-dependency-with-a-self-sustaining-sales-pipeline/",
    logo: "assets/client-franchise-rocket-color.png",
    accent: "#f07b34",
    ...
    lessons: [
      ...
      ["Use spend as a signal", "Existing advertising investment indicated both belief in marketing and potential dissatisfaction."],
      ["Own the relationship", "Direct outreach protected margin and gave the agency more control over growth."]
    ],
    fitTitle: "Relevant for specialist agencies that depend on referrals, partners or expensive paid acquisition.",
    fit: "The model is strongest when the target market can be mapped, the buyer already demonstrates relevant spend and direct relationships materially improve margin or retention."
  },
  "conveyor": {
    name: "Conveyor",
    ...
    size: "11-50 employees",
    website: "https://conveyormg.com/",
    source: "https://www.salessourcers.com/built-a-scalable-outbound-engine-that-kept-the-pipeline-full-and-freed-leadership-to-focus-on-growth/",
    logo: "assets/client-conveyor-color.png",
    accent: "#3186c7",
    ...
    primaryMetric: "$62K",
    primaryLabel: "revenue generated",
    metrics: [["53", "qualified leads"], ["21", "sales meetings"], ["6", "new clients"], ["3 months", "campaign period"]],
    ...
    challenges: [
      "The pipeline rose and fell with the amount of time leadership could spare for prospecting.",
    ...
    quoteLabel: "WRITTEN CLIENT PERSPECTIVE",
    quote: "The pipeline no longer rises and falls with my schedule. I can focus on clients while opportunities keep coming in.",
    founderImage: "assets/founder-amy.png",
    ...
    fit: "This approach is useful when the business has clear proof and a defined offer but needs prospecting to continue independently of leadership's client calendar."
  }
};
...
const videoThumbs = {
  ...
  revcat: "assets/testimonial-revcat-v2.jpg",
  "the-recipe": "assets/testimonial-recipe.webp",
  fivex: "assets/testimonial-fivex.webp",
  "franchise-rocket": "assets/testimonial-franchise.webp"
};
